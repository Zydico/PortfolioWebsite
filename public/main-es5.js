...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppFfxivChecklistFfxivChecklistComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function FfxivChecklistComponent_span_43_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function FfxivChecklistComponent_span_49_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    ...
    function () {
      ...
      _createClass(FfxivChecklistComponent, [{
        ...
        value: function ngOnInit() {
          ...
          var minicactpot = document.getElementById('mini-cactpot');
          var beasttribes = document.getElementById('beast-tribes');
          var gcturnins = document.getElementById('gc-turnins');
          var map = document.getElementById('map');
          var squadron = document.getElementById('squadron');
          var raids = document.getElementById('raids');
          var tomestones = document.getElementById('tomestones');
          var customdeliveries = document.getElementById('custom-deliveries');
          var jumbocactpot = document.getElementById('jumbo-cactpot');
          var wondroustails = document.getElementById('wondrous-tails');
          var fashionreport = document.getElementById('fashion-report');
          var maskedcarnivale = document.getElementById('masked-carnivale');
          var domanenclave = document.getElementById('doman-enclave');
        ...
        value: function getTime() {
          ...
          var dailyGCReset = new Date(now.getUTCFullYear(), now.getUTCMonth(), now.getUTCDate(), 20, 0, 0);
          ...
          var weeklyReset = new Date(now.getUTCFullYear(), now.getUTCMonth(), now.getUTCDate() + (7 - now.getUTCDay() + 2) % 7, 8, 0, 0);
          ...
          var maskedcarnivale = document.getElementById('masked-carnivale');
          var domanenclave = document.getElementById('doman-enclave');
          var ffxivDailyReset = new Date(this.getCookie('ffxiv-dailyReset'));
          ...
          var ffxivGCReset = new Date(this.getCookie('ffxiv-gcreset'));
          ...
          var ffxivWeeklyReset = new Date(this.getCookie('ffxiv-weeklyReset'));
        ...
        key: "getManualTimeDifference",
        value: function getManualTimeDifference(timer) {
          if (!timer) return null;
          var now = new Date();
          var nowUTC = new Date(now.getUTCFullYear(), now.getUTCMonth(), now.getUTCDate(), now.getUTCHours(), now.getUTCMinutes(), now.getUTCSeconds());
          var difference = timer.getTime() - nowUTC.getTime();
          var hours = this.convertTime(Math.floor(difference / (1000 * 60 * 60) % 24));
          var minutes = this.convertTime(Math.floor(difference / (1000 * 60) % 60));
        ...
        key: "checkTimer",
        value: function checkTimer(input, type) {
          if (input.checked) {
            var now = new Date();
            var nowUTC = new Date(now.getUTCFullYear(), now.getUTCMonth(), now.getUTCDate(), now.getUTCHours(), now.getUTCMinutes(), now.getUTCSeconds());
    ...
    FfxivChecklistComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function FfxivChecklistComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function FfxivChecklistComponent_Template_input_click_39_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);

            var _r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](40);

            return ctx.checkTimer(_r9, "map");
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function FfxivChecklistComponent_Template_input_click_45_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r21);

            var _r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](46);

            return ctx.checkTimer(_r11, "squadron");
          });
        ...
        if (rf & 2) {
          var _r14 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](64);
          ...
          var _r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](33);

          var _r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](40);

          var _r11 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](46);

          var _r13 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](59);
          ...
          var _r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](74);

          var _r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](79);

          var _r18 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](84);

          var _r19 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](89);

          var _r20 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](94);
  ...
  function srcAppPortfolioComponentsProjectsHomeProjectsHomeComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    ProjectsHomeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 39,
      vars: 0,
      consts: [[1, "projects-header"], ["id", "projects-container"], [1, "project", 3, "click"], ["id", "sort-algorithm-visualizer", 1, "blur"], [1, "project-name"], [1, "project"], ["id", "uwtournaments", 1, "blur"], [1, "project-description"], [1, "project-description-background"], [1, "project-description-container"], ["id", "uwtournaments-image", 1, "project-description-image"], [1, "project-description-header"], ["href", "https://uwtournaments.herokuapp.com/roster", "target", "_blank", 1, "project-description-link"], [1, "project-description-text"], ["height", "15", "width", "15", 1, "project-description-svg"], ["x1", "0", "y1", "0", "x2", "15", "y2", "15", 2, "stroke", "rgb(48, 48, 48)", "stroke-width", "3"], ["x1", "0", "y1", "15", "x2", "15", "y2", "0", 2, "stroke", "rgb(48, 48, 48)", "stroke-width", "3"], ["href", "https://uwtournaments.herokuapp.com/roster", "target", "_blank", 1, "project-description-link-button"], ["id", "ffxiv-checklist", 1, "blur"]],
      template: function ProjectsHomeComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function ProjectsHomeComponent_Template_div_click_4_listener() {
